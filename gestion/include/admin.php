     ...
     <h4 class="mb-2 mb-sm-0 pt-1">
        ...
        <div class="card-body d-sm-flex  ">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
		    ...
		    <button class="btn btn-primary btn-sm my-0 p" data-toggle="modal" data-target="#myModalajouterAdmin">
			  AJOUTER COMPTE
            </button>
			  
			
			 <button class="btn btn-secondary btn-sm my-0 p"  onclick='window.location.href="index_user.php?choix=listecompte&code_compte=<?php if(isset($_GET['code_compte'])){  echo $code_compte; }?>";'>
			   LISTE DES COMPTES
            </button>
