    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
      <div class="container-fluid">
        ...
        <a class="navbar-brand waves-effect" href="#" >
          <strong class="blue-text">SUIVI DE COURRIER</strong>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link waves-effect" href="index_user.php?choix=mon_compte&code_compte=<?php if(isset($_GET['code_compte'])){  echo $code_compte; }?>">Accueil
          ...
          <ul class="navbar-nav nav-flex-icons">
		   ...
		   <?php  if($type_compte=="ADMINISTRATEUR"){ ?> 
            ...
            <a   class="nav-link border border-light rounded waves-effect" href="index_user.php?choix=listecompte&code_compte=<?php if(isset($_GET['code_compte'])){  echo $code_compte; }?>" >
				...
				<i  class="fas fa-list mr-2" >&nbsp; Liste compte</i>
    ...
    <div class="sidebar-fixed position-fixed">
     <br/> 
      ...
      <div class="list-group list-group-flush">
        <a href="index_user.php?choix=mon_compte&code_compte=<?php if(isset($_GET['code_compte'])){  echo $code_compte; }?>" class="list-group-item active waves-effect">
